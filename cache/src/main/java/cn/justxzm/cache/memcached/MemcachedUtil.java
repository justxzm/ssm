package cn.justxzm.cache.memcached;

/**
 * Created by XZM on 2017/4/5.
 */
...
public class MemcachedUtil {
    ...
    static{
        ...
        maxClient = FileUtil.getInt(props, "", maxClient);
        expireTime = FileUtil.getInt(props, "memcached.expiretime", expireTime);
        maxConnectionPoolSize = FileUtil.getInt(props, "memcached.connection.poolsize", maxConnectionPoolSize);
        op_time = FileUtil.getLong(props, "memcached.op.timeout", op_time);
        ...
        if(StringUtils.isNotBlank(servers)){
            ...
            transcoder.setCompressionMode(CompressionMode.GZIP);//压缩算法
            ...
            for(int i=0;i<maxClient;i++){
                try {
                    ...
                    client.setOpTimeout(op_time);//设置操作超时时间，默认为1s
    ...
    public static void main(String[] args) {
        ...
        System.out.println(MemcachedUtil.setCache(CachePrefix.USER_MANAGEMENT,"hello4", "world"));
        System.out.println(MemcachedUtil.getCache(CachePrefix.USER_MANAGEMENT,"hello4"));
